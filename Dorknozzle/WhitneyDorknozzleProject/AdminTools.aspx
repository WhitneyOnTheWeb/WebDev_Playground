<%@ Page Title="" Language="C#" MasterPageFile="~/Dorknozzle.master" AutoEventWireup="true" Inherits="AdminTools" Codebehind="AdminTools.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    ...
    <p>
        ...
        <asp:Button ID="deleteButton" enabled="false" runat="server" 
            OnClick="deleteButton_Click" Text="Delete Employee" />
    </p>
</asp:Content>
